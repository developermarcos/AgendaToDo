...
{
    public class RepositorioCompromissoArquivoSeparado : RepositorioBaseArquivosDiferentes<Compromisso>
    {
        public RepositorioCompromissoArquivoSeparado() : base(new SerializadorEmJsonNewton<Compromisso>(@"C:\Users\marco\source\repos\AgendaToDo\Repositorio.Tarefa\Data\compromissos.json"))
        {
        }
